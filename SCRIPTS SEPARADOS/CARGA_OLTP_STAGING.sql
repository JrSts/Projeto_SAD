...
DECLARE C_CURSOR CURSOR FOR SELECT COD_DIVIDA, COD_CLIENTE, COD_FUNCIONARIO, COD_CATEGORIA, DATA, VALOR FROM OLTP.TB_DIVIDA
OPEN C_CURSOR
FETCH C_CURSOR INTO @COD_DIVIDA, @COD_CLIENTE, @COD_FUNCIONARIO, @COD_CATEGORIA, @DATA_DIVIDA, @VALOR
WHILE @@FETCH_STATUS = 0
	BEGIN
		...
		INSERT INTO STG.AUX_DIVIDA VALUES (@DATA_CARGA, @COD_DIVIDA, @COD_CLIENTE, @COD_FUNCIONARIO, @COD_CATEGORIA, @DATA_DIVIDA, @VALOR)
		FETCH C_CURSOR INTO @COD_DIVIDA, @COD_CLIENTE, @COD_FUNCIONARIO, @COD_CATEGORIA, @DATA_DIVIDA, @VALOR
	END
CLOSE C_CURSOR
DEALLOCATE C_CURSOR
